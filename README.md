...
- 사용 가능한 기술 스택: Python, JavaScript, CSS
...
## 🧑‍💻 역할 & 기술
- 프로젝트에서 백엔드 개발 역할을 맡아 기능 구현과 데이터 처리 로직을 담당함 (Python)
- 데이터를 추출해서 .csv 파일로 저장하는 python 코드 작성 & Github 리포지토리에 있는 데이터 파일들을 Fetch API로 CSV 데이터 로드해서 시각화하
